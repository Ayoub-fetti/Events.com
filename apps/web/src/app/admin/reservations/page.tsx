...
export default function AdminReservations() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium border ${statusStyles[status as keyof typeof statusStyles] || statusStyles.pending}`}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500">Manage and review all event reservations</p>
      </div>
            ...
            <tbody className="divide-y divide-white/10">
              {reservations.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-16 text-center">
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <div>
                        <p className="text-gray-400 font-medium mb-1">No reservations found</p>
                        <p className="text-sm text-gray-500">Reservations will appear here once users start booking events</p>
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                reservations.map((reservation) => (
                  <tr key={reservation._id} className="hover:bg-white/5 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-gray-300 text-sm">
                        {new Date(reservation.createdAt || Date.now()).toLocaleDateString()}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        {reservation.status === 'pending' && (
                          <>
                            ...
                            <button
                              onClick={() => handleStatusChange(reservation._id, 'refused')}
